...
insert into services (slug, tag, title, description, accent, sort_order) values
  ...
  ('silver-town', '케어특화', '실버타운', '태호요양스테이가 제안하는 케어 특화 시니어 레지던스를 만나보세요.', '#1D3557', 4),
  ('caregiver-signup', '구직중이신가요?', '요양보호사 등록', '태호요양과 함께 좋은 조건의 요양보호사 일자리를 시작해보세요.', '#F4A300', 5)
...
insert into reviews (category, name, rating, content) values
  ...
  ('요양원', '보호자 최◯◯ 님', 4, '24시간 케어가 필요한 상황이라 걱정이 많았는데, 상담부터 입소까지 태호요양이 전 과정을 함께해줘서 든든했습니다.'),
...
insert into staff_stories (role, name, title, excerpt, sort_order) values
  ('센터장', '태호요양 방문요양센터', '"어르신 한 분 한 분의 하루가 저의 하루예요"', '처음엔 낯설어하시던 어르신들도 시간이 지나면 가족처럼 대해주세요. 그 신뢰가 제일 큰 보람입니다.', 0),
  ('요양보호사', '3년차 태호요양 요양보호사', '"교육 시스템 덕분에 자신감 있게 시작했어요"', '입사 전 체계적인 실무 교육을 받아서 현장에 나가서도 당황하지 않고 어르신을 케어할 수 있었어요.', 1),
  ('주간보호센터 원장', '태호요양 주간보호센터', '"프로그램 하나하나가 어르신의 웃음이 됩니다"', '인지활동, 미술, 원예 프로그램을 준비할 때마다 어르신들이 즐거워하실 모습을 상상하며 일합니다.', 2);
...
insert into company_info (name, biz_number, ceo, address, email, ir_email, phone, hours) values
  ('태호요양(주)', '507-81-15401', '김태성', '서울특별시 서초구 서초대로 396, 4층 (서초동, 강남빌딩)', 'info@caring.co.kr', 'ir@caring.co.kr', '1522-6585', '9:00 ~ 22:00 (주말·공휴일 포함)')
